...
We can model the call buyer payoff for a near-the-money QQQ Jan 20th, 2023 call if we had bought the option on Friday, July 1st 2022. First, we need to grab the data from our PosgreSQL database.
...
# first we have to create a mid price 
qqq_atm_call_jan_twenty$mid <- qqq_atm_call_jan_twenty$ask + qqq_atm_call_jan_twenty$bid / 2
...
# first we have to create a mid price 
qqq_atm_put_jan_twenty$mid <- qqq_atm_put_jan_twenty$ask + qqq_atm_put_jan_twenty$bid / 2
...
Long vertical spreads are constructed by buying a contract and selling another at a different strike for a net initial cost. The premium obtained up-front from selling one contract finances the long leg. This position insures that the long leg will be further in-the-money than the short leg, meaning if the short leg is breached the trade will have reached maximum profit. Let's first look at the payoff again for a Jan 20, 2023 QQQ $280 Call.
...
We can mirror a vertical debit spread for a put by buying a put and selling another further out-of-the-money. Again here is a long put (lets choose slightly out of the money).
