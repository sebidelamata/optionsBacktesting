...
The [Raspberry Pi](https://www.canakit.com/raspberry-pi-4-extreme-kit.html) is the perfect tool to carry out our scraping needs. It's portable (currently hidden behind a night stand), uses very little power, I don't have to keep my main laptop on all the time, and we can dedicate it solely to our project.
